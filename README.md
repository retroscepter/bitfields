# bitfields [![view on npm](http://img.shields.io/npm/v/bitfields.svg)](https://www.npmjs.org/package/bitfields)

Bitfields made easy in JavaScript, compatible with modern browsers and Node.js.
...
For browser usage, you can use something like UNPKG:

```HTML
<script src="https://unpkg.com/bitfields@latest/lib/Bitfield.js"></script>
```
